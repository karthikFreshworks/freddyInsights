...
@Slf4j
@Component(AIHandlerConstant.APACHE_HTTP4_POST)
public class ApacheHttp4PostRequestHandlerImpl extends AbstractHttp4RequestHandler<AIServiceMO, HttpUriRequest> {
    @Override
    public HttpUriRequest buildHttpRequest(AIServiceMO aiServiceMO) {
        ...
        return super.createHtt4Request(aiServiceMO, HttpMethods.POST, entity);
    }
}
