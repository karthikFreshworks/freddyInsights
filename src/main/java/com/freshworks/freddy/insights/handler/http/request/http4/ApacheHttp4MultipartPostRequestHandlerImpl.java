...
@Slf4j
@Component(AIHandlerConstant.APACHE_HTTP4_MULTIPART_POST)
public class ApacheHttp4MultipartPostRequestHandlerImpl
    ...
    public HttpUriRequest buildHttpRequest(AIServiceMO aiServiceMO) {
        ...
        return super.createHtt4Request(aiServiceMO, HttpMethods.POST, customEntity);
    }
}
