...
@Slf4j
@Component(AIHandlerConstant.INSIGHTS_ADDON_HANDLER)
public class InsightsAddonHandlerImpl extends AbstractAIAddonHandler<AIFreddyAddonMO> {
    @Autowired
    ...
    public ESCriteriaBuilder.Builder getInsightSearchMOBuilder(AIFreddyAddonMO aiFreddyAddonMO) {
        log.info("Executing insights addon handler for insights");
    ...
    public ESCriteriaBuilder.Builder getPromptSearchMOBuilder(AIFreddyAddonMO aiFreddyAddonMO) {
        log.info("Executing insights addon handler for prompts");
        var tenants = aiFreddyAddonMO.getTenants();
