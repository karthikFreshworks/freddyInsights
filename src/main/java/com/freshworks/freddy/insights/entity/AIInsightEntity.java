...
public class AIInsightEntity implements AIEntityInterface, Serializable {
    private String id;
    ...
    @Transient
    private List<AIPromptEntity> prompts;
    private String languageCode;
    private List<AIInsightTranslationDTO> translatedFields;
